...
public class NoteCreater : MonoBehaviour
{
    ...
    void Stage1N()
    {
       ...
       if (isTe)
       {
            ...
            else if ((noteCount%16==3||noteCount%16==5||noteCount%16==6||noteCount%16==8||noteCount%16==10||noteCount%16==12||noteCount%16==14||noteCount%16==0) && (noteCount > 448 && noteCount < 580)) //畴飘 积己
            {
                longNote.SetActive(false);
                NoteManager.isLong = false;
                NoteCreate();
